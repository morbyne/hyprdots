    ...
    Spicetify.React.useEffect(() => {
      ...
      const properties = {
        ...
        "--spice-equalizer": document.querySelector(
          ...
          ? `url('https://github.com/everviolet/spicetify/blob/main/assets/${colorScheme}/equalizer-animated-${accent}.gif?raw=true')`
